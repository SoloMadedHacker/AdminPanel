...
ScreenGui.ResetOnSpawn = false -- Prevents GUI from resetting on player respawn
...
-- Create Corner for Toggle Button
local Corner = Instance.new("UICorner")
Corner.Name = "Corner"
Corner.Parent = Toggle

-- Toggle Orion function on button click
...
imageButton.Position = UDim2.new(0.50, 0, 0.05, -34)
imageButton.AnchorPoint = Vector2.new(0.5, 0)
imageButton.Image = "rbxassetid://85282499566609"
...
-- Create black GUI with TextBox
local executorGui = Instance.new("Frame")
executorGui.Size = UDim2.new(0.8, 0, 0.2, 0)
executorGui.Position = UDim2.new(0.5, 0, 0.5, 0)
executorGui.AnchorPoint = Vector2.new(0.5, 0.5)
executorGui.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
...
local function executeScript(scriptText)
    local success, errorMessage = pcall(function()
        loadstring(scriptText)()  -- Executes the script
    end)
...
-- Hide GUI on enter and execute the script
textBox.FocusLost:Connect(function(enterPressed)
    if enterPressed then
        executorGui.Visible = false
        local scriptText = textBox.Text
        executeScript(scriptText)  -- Executes the script
        textBox.Text = ""  -- Clear text box after execution
    end
end)
...
-- Define conversion rates (example rates, adjust as needed)
local conversionRates = {
    MYR = {MYR = 1, Rupee = 17.5, Pound = 0.18, Dollar = 0.22, Won = 274.8, Yuan = 1.5, Yen = 33, Euro = 0.21, AUD = 0.35, CAD = 0.31, SwissFranc = 0.20, Peso = 11.2, Rand = 4.2, Lira = 6.5, Ruble = 23, Dirham = 0.81},
    Rupee = {MYR = 0.057, Rupee = 1, Pound = 0.010, Dollar = 0.012, Won = 15.7, Yuan = 0.086, Yen = 1.9, Euro = 0.012, AUD = 0.020, CAD = 0.018, SwissFranc = 0.011, Peso = 0.64, Rand = 0.24, Lira = 0.37, Ruble = 1.3, Dirham = 0.046},
    Pound = {MYR = 5.5, Rupee = 100, Pound = 1, Dollar = 1.38, Won = 1572, Yuan = 8.7, Yen = 190, Euro = 1.16, AUD = 1.89, CAD = 1.7, SwissFranc = 1.09, Peso = 64.3, Rand = 24.3, Lira = 37.2, Ruble = 130, Dirham = 4.6},
    Dollar = {MYR = 4.5, Rupee = 83, Pound = 0.72, Dollar = 1, Won = 1150, Yuan = 7.2, Yen = 145, Euro = 0.85, AUD = 1.36, CAD = 1.27, SwissFranc = 0.92, Peso = 57.5, Rand = 21.5, Lira = 33, Ruble = 100, Dirham = 3.67},
    Won = {MYR = 0.0036, Rupee = 0.064, Pound = 0.00064, Dollar = 0.00087, Won = 1, Yuan = 0.0062, Yen = 0.13, Euro = 0.00074, AUD = 0.0012, CAD = 0.0011, SwissFranc = 0.0008, Peso = 0.05, Rand = 0.02, Lira = 0.03, Ruble = 0.087, Dirham = 0.0032},
    Yuan = {MYR = 0.67, Rupee = 11.6, Pound = 0.12, Dollar = 0.14, Won = 162.6, Yuan = 1, Yen = 20.1, Euro = 0.12, AUD = 0.19, CAD = 0.18, SwissFranc = 0.13, Peso = 8, Rand = 3, Lira = 4.5, Ruble = 15, Dirham = 0.55},
    Yen = {MYR = 0.030, Rupee = 0.53, Pound = 0.0053, Dollar = 0.0069, Won = 7.7, Yuan = 0.050, Yen = 1, Euro = 0.0059, AUD = 0.0094, CAD = 0.0087, SwissFranc = 0.0063, Peso = 0.4, Rand = 0.15, Lira = 0.22, Ruble = 0.72, Dirham = 0.027},
    Euro = {MYR = 4.8, Rupee = 89, Pound = 0.86, Dollar = 1.17, Won = 1345, Yuan = 8.3, Yen = 168, Euro = 1, AUD = 1.6, CAD = 1.5, SwissFranc = 1.08, Peso = 67.6, Rand = 25.3, Lira = 39, Ruble = 132, Dirham = 4.3},
    AUD = {MYR = 3.0, Rupee = 55, Pound = 0.53, Dollar = 0.74, Won = 843, Yuan = 5.2, Yen = 105, Euro = 0.63, AUD = 1, CAD = 0.93, SwissFranc = 0.67, Peso = 42.3, Rand = 15.8, Lira = 24.3, Ruble = 82, Dirham = 2.8},
    CAD = {MYR = 3.5, Rupee = 63, Pound = 0.59, Dollar = 0.79, Won = 929, Yuan = 5.7, Yen = 115, Euro = 0.69, AUD = 1.08, CAD = 1, SwissFranc = 0.72, Peso = 45.6, Rand = 17.1, Lira = 26.5, Ruble = 90, Dirham = 3.3},
    SwissFranc = {MYR = 4.6, Rupee = 81, Pound = 0.92, Dollar = 1.09, Won = 1270, Yuan = 7.6, Yen = 155, Euro = 0.92, AUD = 1.49, CAD = 1.39, SwissFranc = 1, Peso = 63.5, Rand = 23.8, Lira = 37, Ruble = 125, Dirham = 4.5},
    Peso = {MYR = 0.089, Rupee = 1.57, Pound = 0.016, Dollar = 0.018, Won = 20.1, Yuan = 0.13, Yen = 2.5, Euro = 0.015, AUD = 0.023, CAD = 0.022, SwissFranc = 0.016, Peso = 1, Rand = 0.37, Lira = 0.57, Ruble = 2, Dirham = 0.07},
    Rand = {MYR = 0.24, Rupee = 4.2, Pound = 0.042, Dollar = 0.047, Won = 54, Yuan = 0.33, Yen = 7, Euro = 0.04, AUD = 0.063, CAD = 0.058, SwissFranc = 0.042, Peso = 2.7, Rand = 1, Lira = 1.54, Ruble = 5.3, Dirham = 0.19},
    Lira = {MYR = 0.15, Rupee = 2.7, Pound = 0.027, Dollar = 0.03, Won = 35, Yuan = 0.22, Yen = 4.5, Euro = 0.025, AUD = 0.038, CAD = 0.035, SwissFranc = 0.025, Peso = 1.75, Rand = 0.65, Lira = 1, Ruble = 3.4, Dirham = 0.12},
    Ruble = {MYR = 0.043, Rupee = 0.76, Pound = 0.0076, Dollar = 0.01, Won = 11.4, Yuan = 0.07, Yen = 1.4, Euro = 0.0065, AUD = 0.01, CAD = 0.009, SwissFranc = 0.0068, Peso = 0.5, Rand = 0.19, Lira = 0.3, Ruble = 1, Dirham = 0.037},
    Dirham = {MYR = 1.2, Rupee = 21.5, Pound = 0.21, Dollar = 0.27, Won = 315, Yuan = 1.9, Yen = 40, Euro = 0.23, AUD = 0.36, CAD = 0.33, SwissFranc = 0.23, Peso = 14.7, Rand = 5.5, Lira = 8.3, Ruble = 27, Dirham = 1}
}
...
-- Add Dropdowns
local convertFrom = "MYR"
local convertTo = "Dollar"
local amountToConvert = 1

Currency:AddDropdown({
    Name = "Convert From",
    Default = "MYR",
    Options = {"MYR", "Rupee", "Pound", "Dollar", "Won", "Yuan", "Yen", "Euro", "AUD", "CAD", "SwissFranc", "Peso", "Rand", "Lira", "Ruble", "Dirham"},
    Callback = function(value)
        convertFrom = value
    end
})
...
Currency:AddTextbox({
    ...
    TextDisappear = true,
    Callback = function(value)
        amountToConvert = tonumber(value)
    end
})
...
Currency:AddButton({
    Name = "Convert",
    Callback = function()
        local rate = conversionRates[convertFrom][convertTo]
        local result = amountToConvert * rate
        OrionLib:MakeNotification({
            Name = "Conversion Result",
            Content = amountToConvert .. " " .. convertFrom .. " = " .. result .. " " .. convertTo,
            Image = "rbxassetid://4483345998",
            Time = 5
        })
    end
